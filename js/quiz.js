...
let nbOfQuestion = document.querySelector('.numberOfQuestion');
...
function setQuestion(index) {
    ...
    nbOfQuestion.innerText = index + 1;
...
function createResult() {
    ...
    sum += points;
    playCount += 1;
    avgPoints = sum / playCount;
    localStorage.setItem("avgPoints", avgPoints);
    localStorage.setItem("playCount", playCount);
    localStorage.setItem("sum", sum);
    averageElem.innerHTML = avgPoints;
}
...
function clearAnswers() {
    answers[0].classList.remove("correct", "incorrect");
    answers[1].classList.remove("correct", "incorrect");
    answers[2].classList.remove("correct", "incorrect");
    answers[3].classList.remove("correct", "incorrect");
}
